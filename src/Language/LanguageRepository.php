...
class LanguageRepository implements LanguageRepositoryInterface
{
    ...
    protected $availableLocales = [
        ...
        'ja', 'jmc', 'jv', 'ka', 'kab', 'kam', 'kde', 'kea', 'khq', 'ki', 'kk',
        ...
        'nus', 'nyn', 'om', 'or', 'os', 'pa', 'pl', 'ps', 'ps-PK', 'pt',
        ...
        'sr-Latn-ME', 'sr-Latn-XK', 'sv', 'sv-FI', 'sw', 'sw-CD', 'sw-KE',
        'ta', 'te', 'teo', 'tg', 'th', 'ti', 'tk', 'to', 'tr', 'tt', 'twq',
        'tzm', 'ug', 'uk', 'ur', 'ur-IN', 'uz', 'uz-Cyrl', 'vai', 'vai-Latn',
        'vi', 'vun', 'wae', 'wo', 'xog', 'yav', 'yi', 'yo', 'yo-BJ', 'yue',
        'yue-Hans', 'zgh', 'zh', 'zh-Hant', 'zh-Hant-HK', 'zu',
    ];

...
class LanguageRepository implements LanguageRepositoryInterface
{
    ...
    protected array $availableLocales = [
        ...
        'ar-LY', 'ar-SA', 'arn', 'as', 'asa', 'ast', 'az', 'az-Arab',
        'az-Cyrl', 'ba', 'bal', 'bal-Latn', 'bas', 'be', 'bem', 'bez', 'bg',
        'bgc', 'bgn', 'bho', 'blo', 'blt', 'bn', 'bn-IN', 'bo', 'br', 'brx',
        'bs', 'bs-Cyrl', 'bss', 'bua', 'ca', 'cch', 'ccp', 'ce', 'ceb', 'cgg',
        'cho', 'chr', 'cic', 'ckb', 'co', 'cs', 'csw', 'cv', 'cy', 'da', 'dav',
        'de', 'de-AT', 'de-CH', 'doi', 'dsb', 'dua', 'dz', 'ebu', 'ee', 'el',
        'el-polyton', 'en', 'en-001', 'en-AU', 'en-CA', 'en-Dsrt', 'en-EE',
        'en-GB', 'en-GE', 'en-LT', 'en-LV', 'en-UA', 'es', 'es-419', 'es-AR',
        'es-BO', 'es-CL', 'es-CO', 'es-CR', 'es-DO', 'es-EC', 'es-GT', 'es-HN',
        'es-MX', 'es-NI', 'es-PA', 'es-PE', 'es-PR', 'es-PY', 'es-SV', 'es-US',
        'es-VE', 'et', 'eu', 'ewo', 'fa', 'fa-AF', 'fi', 'fil', 'fo', 'fr',
        'fr-BE', 'fr-CA', 'fr-CH', 'frr', 'fur', 'fy', 'ga', 'gaa', 'gd', 'gl',
        'gn', 'gsw', 'gu', 'guz', 'haw', 'he', 'hi', 'hi-Latn', 'hnj', 'hr',
        'hsb', 'ht', 'hu', 'hy', 'id', 'ie', 'ig', 'ii', 'io', 'is', 'it',
        'ja', 'jbo', 'jgo', 'jmc', 'ka', 'kaa', 'kab', 'kaj', 'kam', 'kcg',
        'kde', 'kea', 'kek', 'ken', 'kgp', 'khq', 'ki', 'kk', 'kk-Arab', 'kkj',
        'kl', 'kln', 'km', 'ko', 'kok', 'kok-Latn', 'kpe', 'ks', 'ks-Deva',
        'ksb', 'ksf', 'ksh', 'ku', 'kw', 'kxv', 'kxv-Deva', 'kxv-Orya',
        'kxv-Telu', 'ky', 'lag', 'lb', 'lg', 'lij', 'lkt', 'lld', 'lmo', 'ln',
        'lo', 'lrc', 'lt', 'lu', 'luo', 'luy', 'lv', 'lzz', 'mai', 'mas',
        'mdf', 'mer', 'mfe', 'mg', 'mgh', 'mgo', 'mi', 'mic', 'mk', 'mn',
        'mn-Mong-MN', 'mni', 'mni-Mtei', 'moh', 'mr', 'ms', 'mt', 'mua', 'mus',
        'my', 'myv', 'mzn', 'naq', 'nd', 'nds', 'ne', 'nl', 'nmg', 'nn', 'nnh',
        'no', 'nqo', 'nso', 'nus', 'nv', 'ny', 'nyn', 'oc', 'oka', 'om', 'or',
        'os', 'osa', 'pa', 'pa-Arab', 'pap', 'pcm', 'pis', 'pl', 'pms', 'ps',
        'ps-PK', 'pt', 'pt-PT', 'qu', 'quc', 'raj', 'rhg', 'rif', 'rm', 'rn',
        'ro', 'ro-MD', 'rof', 'ru', 'rw', 'rwk', 'sa', 'sah', 'saq', 'sbp',
        'sc', 'scn', 'sdh', 'se', 'se-FI', 'seh', 'ses', 'sg', 'shn', 'si',
        'sk', 'skr', 'sl', 'sma', 'smj', 'smn', 'sms', 'sn', 'so', 'sq', 'sr',
        ...
        'tig', 'tk', 'tn', 'tok', 'tpi', 'tr', 'trv', 'trw', 'tt', 'twq',
        'tyv', 'tzm', 'ug', 'uk', 'ur', 'ur-IN', 'uz', 'uz-Arab', 'uz-Cyrl',
        'vec', 'vi', 'vmw', 'vun', 'wa', 'wae', 'wbp', 'xh', 'xnr', 'xog',
        'yav', 'yi', 'yrl', 'yrl-CO', 'yrl-VE', 'yue', 'yue-Hans', 'za', 'zgh',

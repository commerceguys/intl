...
class LanguageRepository implements LanguageRepositoryInterface
{
    ...
    protected $availableLocales = [
        ...
        'ha', 'he', 'hi', 'hr', 'hsb', 'hu', 'hy', 'id', 'ig', 'is', 'it',
        'ja', 'jmc', 'ka', 'kab', 'kam', 'kde', 'kea', 'khq', 'ki', 'kk',
        'kln', 'km', 'kn', 'ko', 'kok', 'ks', 'ksb', 'ksf', 'ksh', 'ku', 'ky',
        'lag', 'lb', 'lg', 'lkt', 'ln', 'lo', 'lrc', 'lt', 'lu', 'luo', 'luy',
        'lv', 'mas', 'mer', 'mfe', 'mg', 'mgh', 'mk', 'ml', 'mn', 'mr', 'ms',
        'mt', 'mua', 'my', 'mzn', 'naq', 'nb', 'nd', 'ne', 'nl', 'nmg', 'nn',
        'nus', 'nyn', 'om', 'or', 'os', 'pa', 'pl', 'ps', 'pt', 'pt-PT', 'qu',
        'rm', 'rn', 'ro', 'ro-MD', 'rof', 'ru', 'rw', 'rwk', 'sah', 'saq',
        'sbp', 'sd', 'se', 'se-FI', 'seh', 'ses', 'sg', 'shi', 'shi-Latn',
        'si', 'sk', 'sl', 'smn', 'sn', 'so', 'sq', 'sr', 'sr-Cyrl-BA',
        'sr-Cyrl-ME', 'sr-Cyrl-XK', 'sr-Latn', 'sr-Latn-BA', 'sr-Latn-ME',
        'sr-Latn-XK', 'sv', 'sv-FI', 'sw', 'sw-CD', 'sw-KE', 'ta', 'te', 'teo',
        'tg', 'th', 'ti', 'tk', 'to', 'tr', 'tt', 'twq', 'tzm', 'ug', 'uk',
        'ur', 'ur-IN', 'uz', 'uz-Cyrl', 'vai', 'vai-Latn', 'vi', 'vun', 'wae',
        'wo', 'xog', 'yav', 'yi', 'yo', 'yo-BJ', 'yue', 'yue-Hans', 'zgh',

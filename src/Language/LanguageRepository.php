...
class LanguageRepository implements LanguageRepositoryInterface
{
    ...
    protected $availableLocales = [
        ...
        'en-IN', 'eo', 'es', 'es-AR', 'es-BO', 'es-BR', 'es-BZ', 'es-CL',
        'es-CO', 'es-CR', 'es-CU', 'es-DO', 'es-EC', 'es-GT', 'es-HN',
        'es-MX', 'es-NI', 'es-PA', 'es-PE', 'es-PR', 'es-PY', 'es-SV',
        'es-US', 'es-UY', 'es-VE', 'et', 'eu', 'ewo', 'fa', 'fa-AF',
        'ff', 'fi', 'fil', 'fo', 'fr', 'fr-BE', 'fr-CA', 'fr-CH', 'fur',
        'fy', 'ga', 'gd', 'gl', 'gsw', 'gu', 'guz', 'ha', 'he', 'hi', 'hr',
        'hsb', 'hu', 'hy', 'id', 'ig', 'is', 'it', 'ja', 'jmc', 'ka', 'kab',
        'kam', 'kde', 'kea', 'khq', 'ki', 'kk', 'kln', 'km', 'kn', 'ko', 'kok',
        'ks', 'ksb', 'ksf', 'ksh', 'ky', 'lag', 'lb', 'lg', 'lkt', 'ln', 'lo',
        'lrc', 'lt', 'lu', 'luo', 'luy', 'lv', 'mas', 'mer', 'mfe', 'mg',
        'mgh', 'mk', 'ml', 'mn', 'mr', 'ms', 'mt', 'mua', 'my', 'mzn', 'naq',
        'nb', 'nd', 'ne', 'nl', 'nmg', 'nn', 'nus', 'nyn', 'om', 'or', 'os',
        'pa', 'pl', 'ps', 'pt', 'pt-AO', 'pt-CH', 'pt-CV', 'pt-GQ', 'pt-GW',
        'pt-LU', 'pt-MO', 'pt-MZ', 'pt-PT', 'pt-ST', 'pt-TL', 'qu', 'rm',
        'rn', 'ro', 'ro-MD', 'rof', 'ru', 'rw', 'rwk', 'sah', 'saq', 'sbp',
        ...
        'sv', 'sv-FI', 'sw', 'sw-CD', 'sw-KE', 'ta', 'te', 'teo', 'tg', 'th',
        'ti', 'tk', 'to', 'tr', 'tt', 'twq', 'tzm', 'ug', 'uk', 'ur', 'ur-IN',
        'uz', 'uz-Cyrl', 'vai', 'vai-Latn', 'vi', 'vun', 'wae', 'wo', 'xog',
        'yav', 'yi', 'yo', 'yo-BJ', 'zgh', 'zh', 'zh-Hant', 'zh-Hant-HK',
        'zh-Hant-MO', 'zu',
    ];

...
class CurrencyRepository implements CurrencyRepositoryInterface
{
    ...
    protected array $availableLocales = [
        'af', 'agq', 'ak', 'am', 'ar', 'as', 'asa', 'ast', 'az', 'ba',
        'bal-Latn', 'bas', 'be', 'bez', 'bg', 'blo', 'bn', 'bn-IN', 'br',
        'brx', 'bs', 'bs-Cyrl', 'ca', 'ccp', 'ce', 'ceb', 'cgg', 'chr', 'cs',
        'cv', 'cy', 'da', 'dav', 'de', 'de-CH', 'dsb', 'dz', 'ebu', 'ee', 'el',
        'el-polyton', 'en', 'en-001', 'en-AU', 'en-CA', 'en-EE', 'en-GE',
        'en-GG', 'en-IM', 'en-IN', 'en-JE', 'en-LT', 'en-LV', 'en-UA', 'es',
        'es-419', 'es-CL', 'es-GT', 'es-MX', 'es-US', 'es-VE', 'et', 'eu',
        'ewo', 'fa', 'fa-AF', 'fi', 'fil', 'fo', 'fr', 'fr-CA', 'fur', 'fy',
        'ga', 'gd', 'gl', 'gsw', 'gu', 'guz', 'he', 'hi', 'hi-Latn', 'hr',
        'hsb', 'hu', 'hy', 'id', 'ig', 'is', 'it', 'ja', 'jmc', 'ka', 'kab',
        'kam', 'kde', 'kea', 'kgp', 'khq', 'ki', 'kk', 'kk-Arab', 'kln', 'km',
        'ko', 'kok', 'ks', 'ksb', 'ksf', 'ksh', 'ku', 'ky', 'lag', 'lb', 'lg',
        'lld', 'ln', 'lo', 'lt', 'lu', 'luo', 'luy', 'lv', 'mas', 'mer', 'mfe',
        'mg', 'mi', 'mk', 'mn', 'mr', 'ms', 'mua', 'my', 'mzn', 'naq', 'nd',
        'ne', 'nl', 'nmg', 'nn', 'no', 'nqo', 'nyn', 'or', 'pa', 'pcm', 'pl',
        'ps', 'pt', 'pt-PT', 'qu', 'rm', 'rn', 'ro', 'rof', 'ru', 'rwk', 'saq',
        'sbp', 'sc', 'scn', 'seh', 'ses', 'sg', 'shn', 'si', 'sk', 'sl', 'sn',
        'so', 'sq', 'sr', 'sr-Cyrl-BA', 'sr-Latn', 'sr-Latn-BA', 'sv', 'sw',
        'sw-CD', 'sw-KE', 'syr', 'ta', 'te', 'teo', 'tg', 'th', 'ti', 'tk',
        'tr', 'tt', 'twq', 'tzm', 'ug', 'uk', 'ur', 'ur-IN', 'uz', 'uz-Cyrl',
        'vec', 'vi', 'vun', 'xh', 'xnr', 'xog', 'yrl', 'yue', 'yue-Hans',
        'zgh', 'zh', 'zh-Hans-HK', 'zh-Hans-MY', 'zh-Hant', 'zh-Hant-HK', 'zu',
    ];

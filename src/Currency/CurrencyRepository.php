...
class CurrencyRepository implements CurrencyRepositoryInterface
{
    ...
    protected $availableLocales = [
        ...
        'es-US', 'et', 'eu', 'ewo', 'fa', 'fa-AF', 'ff', 'fi', 'fil', 'fo',
        'fr', 'fr-CA', 'fur', 'fy', 'ga', 'gd', 'gl', 'gsw', 'gu', 'guz', 'ha',
        'he', 'hi', 'hr', 'hsb', 'hu', 'hy', 'id', 'is', 'it', 'ja', 'jmc',
        'ka', 'kab', 'kam', 'kde', 'kea', 'khq', 'ki', 'kk', 'kln', 'km', 'kn',
        'ko', 'ks', 'ksb', 'ksf', 'ksh', 'ky', 'lag', 'lb', 'lg', 'ln', 'lo',
        'lt', 'lu', 'luo', 'luy', 'lv', 'mas', 'mer', 'mfe', 'mg', 'mk', 'ml',
        'mn', 'mr', 'ms', 'mua', 'my', 'mzn', 'naq', 'nb', 'nd', 'ne', 'nl',
        'nmg', 'nn', 'nyn', 'or', 'pa', 'pl', 'pt', 'pt-PT', 'rm', 'rn', 'ro',
        'rof', 'ru', 'rwk', 'saq', 'sbp', 'sd', 'seh', 'ses', 'sg', 'shi',
        'shi-Latn', 'si', 'sk', 'sl', 'sn', 'sq', 'sr', 'sr-Latn', 'sv', 'sw',
        'sw-CD', 'ta', 'te', 'teo', 'th', 'tk', 'tr', 'twq', 'tzm', 'ug', 'uk',
        'ur', 'ur-IN', 'uz', 'uz-Cyrl', 'vai', 'vai-Latn', 'vi', 'vun', 'xog',
        'yo', 'yo-BJ', 'yue', 'yue-Hans', 'zgh', 'zh', 'zh-Hans-HK', 'zh-Hant',
        'zh-Hant-HK', 'zu',
    ];
